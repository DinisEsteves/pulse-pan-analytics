...
foreach ($files as $file) {
    ...
    match (true) {
        str_contains($file, determineSeparator('src/PulseAnalytics.php')) => rename($file, determineSeparator('./src/'.$className.'.php')),
        str_contains($file, determineSeparator('src/PulseAnalyticsServiceProvider.php')) => rename($file, determineSeparator('./src/'.$className.'ServiceProvider.php')),
        str_contains($file, determineSeparator('src/Facades/PulseAnalytics.php')) => rename($file, determineSeparator('./src/Facades/'.$className.'.php')),
